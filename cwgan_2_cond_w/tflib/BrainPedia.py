...
def load_ckpt_data(batch_size,list_dir,n_labelled=None):
    ...
    train_file = open('/home/nfs/zpy/BrainPedia/cwgan_2_cond_w/for_nn_classify_2.0_100/true_real.pkl', 'rb')
    dev_file = open('/home/nfs/zpy/BrainPedia/cwgan_2_cond_w/for_nn_classify_2.0_100/dev_dic.pkl', 'rb')
    test_file = open('/home/nfs/zpy/BrainPedia/cwgan_2_cond_w/for_nn_classify_2.0_100/test_dic.pkl', 'rb')
