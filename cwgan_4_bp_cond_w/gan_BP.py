...
sample_dir = './w_weight' + '_' + FLAGS.cond + '_' + FLAGS.concat+'/samples'
test_dir = './w_weight' + '_' +FLAGS.cond + '_' + FLAGS.concat+'/test'
cost_dir = './w_weight' + '_' +FLAGS.cond + '_' + FLAGS.concat+'/cost'
...
if MODE == 'wgan':
    ...
    disc_cost = tf.reduce_mean(disc_fake) - tf.reduce_mean(disc_real) #（tf.multiply(disc_real, prop))
...
with tf.Session() as session:
    ...
    for iteration in xrange(ITERS):
        ...
        if (iteration > 12000):#18000):  # 11000
