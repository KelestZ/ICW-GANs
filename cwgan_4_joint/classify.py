...
flags = tf.app.flags
flags.DEFINE_string("gpu", "2", "gpu_id")
...
train_gen, dev_gen, test_gen = lib.BrainPedia.load_cross2(BATCH_SIZE)
...
with tf.Session() as session:
    ...
    for iteration in xrange(ITERS):
        ...
        '''
        preds_, _, acc, batch_loss_, crct = session.run([preds, disc_train_op,accuracy, batch_loss, correct],
        ...
        if(iteration >=4000):
            ...
            if(iteration%100 ==0):
                print('iteration',iteration,'acc',ac)
