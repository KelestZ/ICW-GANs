...
def pre_class_statics():
    ...
    for img_id in train_list:
        ...
        if (tags[img_id] not in train.keys()):
            ...
            count[tags[img_id]] = 0
            cross[tags[img_id]] = []
        train[tags[img_id]].append(outbrain.reshape([26, 31, 23, 1]))
        count[tags[img_id]] += 1
    ...
    for img_id in test_list:
        ...
        test[tags[img_id]].append(outbrain.reshape([26, 31, 23, 1]))
    ...
    for img_id in dev_list:
        ...
        dev[tags[img_id]].append(outbrain.reshape([26, 31, 23, 1]))
...
def classify(train, test):
    ...
    for train_, test_ in skf.split(test_datas, test_targets):
        ...
        print(classification_report(y_te, results, target_names=target_names))
        print(accuracy_score(y_te, results))
...
def load_gen_data(flag):
    ...
    if flag == 'conditional':
        test_dir = '/home/nfs/zpy/BrainPedia/cwgan_2_cond_w/shuffle1_new04_11111_1/test/'
        ...
        for i in gen_pics:
            ...
            if (i[-2:] == 'gz'):
                ...
                if (count[tag] <= 199):
                    ...
                    down_img = downsample_brain(brain, inmask, 2.0)
                    ...
                    #gen[tag].append(brain)
                    gen[tag].append(outbrain)
                    count[tag] += 1
